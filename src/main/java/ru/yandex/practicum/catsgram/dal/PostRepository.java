...
public class PostRepository extends BaseRepository<Post> {
    private static final String FIND_ALL_QUERY = "SELECT * FROM posts ORDER BY post_date DESC";
    private static final String FIND_BY_ID_QUERY = "SELECT * FROM posts WHERE id = ?";
    private static final String FIND_BY_AUTHOR_QUERY = "SELECT * FROM posts WHERE author_id = ? ORDER BY post_date DESC";
